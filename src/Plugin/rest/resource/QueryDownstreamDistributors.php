 ...
 *
 * @RestResource(
 *   id = "distribution_query_downstream_distributors",
 *   label = @Translation("Query downstream distributors"),
 *   uri_paths = {
 *     "create" = "/api/rest/distribution/query-downstream-distributors"
 *   }
 * )
 */
class QueryDownstreamDistributors extends ResourceBase {
  ...
  /**
   * Constructs a new QueryDownstreamDistributors object.
   *
  ...
  public function post($data) {
    ...
    if (!isset($data['distributor'])) {
      throw new BadRequestHttpException('distributor is required.');
    }
