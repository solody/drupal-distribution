 ...
 * )
 */
class Promotion extends CommissionTypeBase
{
    ...
    {
        $fields['promoter_id'] = BundleFieldDefinition::create('entity_reference')
            ->setLabel(t('推广者'))
            ->setDescription(t('产生分佣项的推广者。'))
            ->setSetting('target_type', 'distribution_promoter')
